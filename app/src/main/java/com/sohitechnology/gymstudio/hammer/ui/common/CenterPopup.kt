...
@Composable
fun CenterPopup(
    uiMessage: com.sohitechnology.gymstudio.hammer.ui.UiMessage,
    onDismiss: () -> Unit,
    ...
    Dialog(
        ...
        Card(
            ...
            Column(
                ...
                Icon(
                    imageVector = if (uiMessage.type == _root_ide_package_.com.sohitechnology.gymstudio.hammer.ui.UiMessageType.ERROR)
                        Icons.Default.Error
                    else
                        Icons.Default.Info,
                    contentDescription = null,
                    tint = if (uiMessage.type == _root_ide_package_.com.sohitechnology.gymstudio.hammer.ui.UiMessageType.ERROR)
