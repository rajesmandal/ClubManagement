package com.sohitechnology.gymstudio.hammer.ui.notification
...
class NotificationViewModel @Inject constructor(
    ...
    private fun processMembersToNotifications(members: List<MemberExpiryData>): List<NotificationItem> {
